...
in the end you should have. a User class, a UserTable class,
a tableManager and the php form to connect to it
...
3.
    ...
    Insert the user input into the MySQL database. 
    You will need to use the pdo methods to connect to the database and insert the data.
